 ...
 * @group weather
 */
class WeatherPermissionTestCase extends \Drupal\simpletest\WebTestBase {
  ...
  public function testPermissions() {
    ...
    $weather_search_page_user = $this->drupalCreateUser([
      'access content',
    ...
    $edit = ['blocks[weather_system_1][region]' => 'sidebar_second'];
